...
export function InvoiceTable({
  ...
  const columns = useMemo<ColumnDef<Invoice>[]>(
    () => [
      { accessorKey: "invoiceNumber", header: t.invoiceNumber, enableSorting: true },
      { id: "paymentStatus", header: t.invoicePaymentStatus, enableSorting: false },
      { accessorKey: "totalAmount", header: t.invoiceTotalAmount, enableSorting: true },
      { accessorKey: "invoiceDate", header: t.invoiceDate, enableSorting: true },
      { id: "dueDate", header: t.invoiceDueDate, enableSorting: false },
      { id: "itemCount", header: t.invoiceItemsSection, enableSorting: false },
  ...
  if (invoices.length === 0)
    return (
      <TableEmptyState
        ...
        title={search ? t.invoiceNoResults : t.invoiceEmptyTitle}
        description={t.invoiceEmptyDesc}
        addLabel={t.invoiceAdd}
        onAdd={onAdd}
      />
    );
  ...
  const colVisibility: Record<string, string> = {
    invoiceNumber: "",
    paymentStatus: "",
    totalAmount: "hidden sm:table-cell",
    invoiceDate: "hidden md:table-cell",
    dueDate: "hidden lg:table-cell",
    itemCount: "hidden xl:table-cell",
  };

  const colMinWidth: Record<string, string> = {
    invoiceNumber: "min-w-[220px]",
    paymentStatus: "min-w-[120px]",
    totalAmount: "min-w-[140px]",
    invoiceDate: "min-w-[130px]",
    dueDate: "min-w-[130px]",
