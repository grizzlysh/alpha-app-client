...
import type { PlacementItem, LicenseItem } from "@/types/user";
import { deleteLicense } from "@/service/userService";

export interface UserLicenseDeleteModalProps {
  userUuid: string;
...
export function UserLicenseDeleteModal({
  userUuid,
  placement,
  license,
  onClose,
  onSuccess,
}: UserLicenseDeleteModalProps): JSX.Element {
  ...
  const mutation = useMutation({
    mutationFn: () => deleteLicense(userUuid, placement.uuid, license.uuid),
    onSuccess: () => {
