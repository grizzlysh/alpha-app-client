...
export default function SelectPharmacyPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    if (!isPlatformUser && pharmacies.length === 1 && !isSelecting) {
      select(pharmacies[0].uuid);
    }
  }, [user, pharmacies, isSelecting, select]);
